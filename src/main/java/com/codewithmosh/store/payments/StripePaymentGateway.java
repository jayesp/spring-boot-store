...
public class StripePaymentGateway implements PaymentGateway {
    ...
    public CheckoutSession createCheckoutSession(Order order) {
        try {
            var builder = SessionCreateParams.builder()
                    ...
                    .setSuccessUrl(websiteUrl + "/checkout-success?orderId=" + order.getId().toString())
    ...
    private static SessionCreateParams.PaymentIntentData createPaymentIntent(Order order) {
        return SessionCreateParams.PaymentIntentData.builder().putMetadata("order_id", order.getId().toString())
                .build();
    }
